...
# Scaling data with standared scalar to get standared deviation
scaler = StandardScaler()
scaledData = scaler.fit_transform(processed)

scaledData['alert'] = numericBinaryData['alert']
X = scaledData.iloc[:,0:scaledData.shape[1]-1]
Y = scaledData[['alert']].values
